...
SET $LNSFichero1=pcktgal
SET $LNSJuego1=Pocket Gal
SET $LNSFichero2=sfiii3nr1
SET $LNSJuego2=SFIII: 3rd Strike
SET $LNSFichero3=ssridersebd
SET $LNSJuego3=Sunset Riders
SET $LNSFechaFin=30/06/18
