...
SET $LNSFichero1=bonzeadv
SET $LNSJuego1=Bonze Adventure
SET $LNSFichero2=mario
SET $LNSJuego2=Mario Bros.
SET $LNSFichero3=wc90b1
SET $LNSJuego3=Euro League
SET $LNSFechaFin=31/03/18
