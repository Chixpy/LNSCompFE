...
SET $LNSFichero1=biomtoy
SET $LNSJuego1=Biomechanical Toy
SET $LNSFichero2=mooncrst
SET $LNSJuego2=Moon Cresta
SET $LNSFichero3=tehkanwc
SET $LNSJuego3=Tehkan World Cup
